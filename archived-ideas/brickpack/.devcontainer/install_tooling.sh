...
# CURRENT_VERSION=$(curl -sSfL https://api.github.com/repos/${CURRENT_REPO}/releases | jq '.[0].tag_name' | tr -d '"')
# curl -sSfL https://github.com/${CURRENT_REPO}/releases/download/${CURRENT_VERSION}/ic-wasm-linux64 -o ic-wasm
# chmod +x ic-wasm

## Install Dfinity candid (`didc`)
# CURRENT_REPO="dfinity/candid"
# CURRENT_VERSION=$(curl -sSfL https://api.github.com/repos/${CURRENT_REPO}/releases | jq '.[0].tag_name' | tr -d '"')
# curl -sSfL https://github.com/${CURRENT_REPO}/releases/download/${CURRENT_VERSION}/didc-linux64
