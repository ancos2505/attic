...
impl Model<AppDatabaseConnection, String, InternalMessage> for SaveEvent {
    fn model(
        ...
        let last_rowid = InternalMessage::db_save_event(db_connection, &new_event)?;
        log::info!("Event created with id: {:?}", &last_rowid);
