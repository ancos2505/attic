...
// Endpoint definition
#[derive(Debug)]
pub struct GetFullNote;

impl Endpoint for GetFullNote {}

impl Name for GetFullNote {
...
impl Presenter<GetFullNote, AppDatabaseConnection, String, InternalMessage> for GetFullNote {}
...
pub async fn handler(mut request: Request<AppGlobalState>) -> tide::Result {
    ...
    GetFullNote::presenter(GetFullNote, &db_connection_app, &request_body)
}
